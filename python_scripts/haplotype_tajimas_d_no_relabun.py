...
def main():
    ...
    description="Calc Tajima's D and nucleotide diversity metrics (and also for the subset of haplotypes in each sample with at least three haplotypes). Also calculate based on all gene sequences from reference genomes. Note that based on this version no relative abundance information is taken into account.",
