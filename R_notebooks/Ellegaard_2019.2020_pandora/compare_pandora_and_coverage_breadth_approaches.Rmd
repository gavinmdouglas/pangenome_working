...
```{r one_sample_depth_compare, fig.width = 8, fig.height = 6}
...
```{r Bifidobacterium_core_gene_evaluate, fig.width=4, fig.height=4}
...
```{r Firm4_core_gene_evaluate, fig.width=4, fig.height=4}
...
```{r Firm5_core_gene_evaluate, fig.width=4, fig.height=4}
...
```{r Gilliamella_core_gene_evaluate, fig.width=4, fig.height=4}
...
```{r Snodgrassella_core_gene_evaluate, fig.width=4, fig.height=4}
...
jaccard_dist_two_vecs <- function(x, y) {
  ...
  # x <- as.numeric(pandora_output_sorted["Gilli_ppiA", ])
  # 
  # y <- as.numeric(breadth_out_0.5_sorted["Gilli_ppiA", ])
  # 
  # print(x)
  # print(y)
...
Gilli_prg_space_counts <- read.table("/data1/gdouglas/projects/honey_bee/ref_genome_pangenomes/ortholog_pandora_prgs/Gilliamella_ortholog_fastas_muscle_aligned/Gilliamella_num_space_per_prg.txt", header = FALSE, sep = " ", row.names = 1)
