...
for (sp in species) {
  ...
  panaroo_tab_path <- paste("/data1/gdouglas/projects/honey_bee/ref_genome_pangenomes/species/highqual_genomes_panaroo", sp, "gene_presence_absence_roary.csv", sep = "/")
...
panaroo_counts["Apilactobacillus_apinorum", ] <- c(1, 1377, 0, 0, 1377)
```
...
<!-- CAZy_annoted_tab$sp <- factor(CAZy_annoted_tab$sp, levels = rev(c("Bifidobacterium", "Firm4", "Firm5", "Gilliamella", "Snodgrassella"))) -->
...
<!-- KEGG_annoted_tab$sp <- factor(KEGG_annoted_tab$sp, levels = rev(c("Bifidobacterium", "Firm4", "Firm5", "Gilliamella", "Snodgrassella"))) -->
...
<!-- ```{r CAZy_sp_relabun_breakdown, fig.width = 8, fig.height = 6} -->
...
<!-- ```{r KEGG_modules_sp_relabun_breakdown, fig.width = 12, fig.height = 8} -->
...
<!-- ```{r KEGG_pathways_sp_relabun_breakdown, fig.width = 10, fig.height = 8} -->
