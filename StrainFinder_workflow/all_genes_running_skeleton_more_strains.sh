...
mkdir -p /data1/gdouglas/projects/honey_bee/combined_Ellegaard.2019.2020/StrainFinder_running/all_gene_output_more_strains/$SPECIES/$GENE/strain_running

cd /data1/gdouglas/projects/honey_bee/combined_Ellegaard.2019.2020/StrainFinder_running/all_gene_output_more_strains/$SPECIES/$GENE/strain_running
