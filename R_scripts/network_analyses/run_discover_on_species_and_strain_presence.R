...
# Species presence / absence testing
...
Ellegaard.2019_samples <- Ellegaard.2019_samples[which(Ellegaard.2019_samples %in% colnames(species_presence))]
Ellegaard.2020_samples <- Ellegaard.2020_samples[which(Ellegaard.2020_samples %in% colnames(species_presence))]
