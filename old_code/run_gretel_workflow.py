...
def main():
    ...
    description="Run gretel workflow, which includes parsing out reads from all samples specific to a particular gene, .",

    epilog='''Usage example:

    python run_gretel_workflow.py --input DIRECTORY_OF_BAMS --id GENE_NAME 
